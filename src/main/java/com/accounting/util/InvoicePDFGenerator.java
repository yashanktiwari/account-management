...
public class InvoicePDFGenerator {
    ...
    public static void generatePurchaseInvoicePDF(PurchaseInvoice invoice, String outputPath, String copyLabel) {
        try {
            ...
            Paragraph title = new Paragraph("Tax Invoice", FontFactory.getFont(FontFactory.TIMES_ROMAN, 14, Font.BOLD, Color.WHITE));
            ...
            // Conservative estimate keeps footer/terms from overflowing page
            ...
            if (allItems.size() <= maxItemsFirstPage) {
                ...
                while (remainingStart < allItems.size()) {
                    ...
                    Paragraph title2 = new Paragraph("Tax Invoice (Continued)", FontFactory.getFont(FontFactory.TIMES_ROMAN, 14, Font.BOLD, Color.WHITE));
    ...
    private static void addTextBasedHeader(Document document) throws DocumentException {
        ...
        // Logo placeholder
        PdfPCell logoCell = new PdfPCell(new Phrase("SE", FontFactory.getFont(FontFactory.TIMES_ROMAN, 36, Font.BOLD, new Color(0, 51, 153))));
        ...
        companyName.add(new Chunk("SIHAG ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 24, Font.BOLD, new Color(0, 51, 153))));
        companyName.add(new Chunk("ENTERPRISE", FontFactory.getFont(FontFactory.TIMES_ROMAN, 24, Font.BOLD, new Color(204, 0, 0))));
        ...
        panGstin.add(new Chunk("DYHPD9230H\n", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.BOLD, new Color(204, 0, 0))));
        panGstin.add(new Chunk("GSTIN : ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10)));
        panGstin.add(new Chunk("24DYHPD9230H1ZJ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.BOLD, new Color(204, 0, 0))));
    ...
    private static void addPurchaseInvoiceDetails(Document document, PurchaseInvoice invoice) throws DocumentException {
        ...
        billedToTable.addCell(nameCell);
    ...
    private static void addLineItemsTable(Document document, java.util.List<InvoiceLineItem> lineItems) throws DocumentException {
        ...
        PdfPCell emptyCell = new PdfPCell(new Phrase("", FontFactory.getFont(FontFactory.TIMES_ROMAN, 7f)));
    ...
    private static void addPurchaseLineItemsTable(Document document, java.util.List<InvoiceLineItem> lineItems) throws DocumentException {
        ...
        PdfPCell totalRemarkCell = new PdfPCell(new Phrase("", FontFactory.getFont(FontFactory.TIMES_ROMAN, 8f)));
    ...
    private static void addTermsAndSignature(Document document) throws DocumentException {
        ...
        if (authSignImg != null || signatureImg != null) {
            Paragraph authPara = new Paragraph("Authorised Signatory", FontFactory.getFont(FontFactory.TIMES_ROMAN, 9));
            authPara.setAlignment(Element.ALIGN_CENTER);
            signatureCell.addElement(authPara);
        } else {
            Paragraph authPara = new Paragraph("\n\n\nAuthorised Signatory", FontFactory.getFont(FontFactory.TIMES_ROMAN, 9));
            authPara.setAlignment(Element.ALIGN_CENTER);
            signatureCell.addElement(authPara);
        }
    ...
    private static void addTextBasedFooter(Document document) throws DocumentException {
        ...
        location.add(new Chunk("📍", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, new Color(204, 0, 0))));
        ...
        contact.add(new Chunk("📧", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, new Color(0, 51, 153))));
        ...
        contact.add(new Chunk(" 9033 777 516 | 94260 36076", 
            FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.BOLD, new Color(204, 0, 0))));
    ...
    private static void addTableCellCenter(PdfPTable table, String text) {
        PdfPCell cell = new PdfPCell(new Phrase(text, FontFactory.getFont(FontFactory.TIMES_ROMAN, 7f)));
        cell.setBorder(Rectangle.BOX);
        cell.setPadding(2f);
        cell.setMinimumHeight(15f);
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
    ...
    private static void addGSTRow(PdfPTable table, String label, String value) {
        PdfPCell labelCell = new PdfPCell(new Phrase(label, FontFactory.getFont(FontFactory.TIMES_ROMAN, 9)));
        labelCell.setBorder(Rectangle.NO_BORDER);
        labelCell.setPadding(2);
        labelCell.setNoWrap(false); // Enable text wrapping
        table.addCell(labelCell);

        PdfPCell valueCell = new PdfPCell(new Phrase(value, FontFactory.getFont(FontFactory.TIMES_ROMAN, 9)));
